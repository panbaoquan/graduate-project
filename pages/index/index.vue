<template>
	<view class="modStyle">
		<scroll-view scroll-top="200px" scroll-y="true" class="scroll-Y" @scroll="scroll" show-scrollbar="true">
			...
			<view class="content">
				<!-- 搜索框-->
				<view  class="searchBarwidth" :class="{searchBarbg:isDown}">
				...
				<!-- 轮播图-->
				<swiper :class="{offsetTop:isDown}" class="swiper" indicator-dots="true" autoplay="true" interval="3000" duration="1000" circular="true">
				...
				<view class="nearStone">
					<view class="nearStone-title">
						附近商家  <!-- 手机屏幕高度 {{testHeight}} -->
					</view>
					<!--筛选模块（封装）-->
					<view class="nearStone-select" @tap="currentScroll">
				...
				<!--附近商家固定的时候-->
				<view  v-show ="isTop" class="nearStone" :class="{nearStoneoffsetTop:isTop}">
					<view class="nearStoneoffsetTop-content">
